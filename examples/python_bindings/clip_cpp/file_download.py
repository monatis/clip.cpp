...
from .exceptions import FileNameAlreadyExists, RepositoryNotFoundError, RepositoryFileNameNotFound
...
def model_info(
    ...
    get_files_metadata = urllib.parse.urlencode({'blobs':files_metadata}) if files_metadata else ""
...
def model_download(
    ...
    def reporthook(count, block_size, total_size):
        ...
        sys.stdout.write(f"\r[{bar}] {progress:.1f}% ({downloaded_chunk/1024**2:.2f} MB/{total_size/1024**2:.0f} MB)")
        sys.stdout.flush()
